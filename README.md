...
## Составные части
* Бэкэнд на ASP.NET Core - [github.com/MapTalkie/maptalkie-backend]()
* Android приложение на Kotlin - [github.com/MapTalkie/maptalkie-android]()
* Веб-приложение на чем-то (не решили пока) - [github.com/MapTalkie/maptalkie-web]()
